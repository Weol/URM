...
urm.restrictions.addbutton.DoClick = function()
	...
	if (#usergroups > 0) and (#strings > 0) then
		...
		TIIP.URM.SendCommand("ulx restrict",string.Implode(",",usergroups),type,string.Implode(",",strings))
	end
end
...
urm.restrictions.deletebutton.DoClick = function()
	...
	if (#usergroups > 0) and (#strings > 0) then
		TIIP.URM.SendCommand("ulx unrestrict",string.Implode(",",usergroups),type,string.Implode(",",strings))
	end
end
