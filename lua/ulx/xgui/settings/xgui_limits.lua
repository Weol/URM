...
urm.limits.addbutton.DoClick = function()
	...
	if (#usergroups > 0) and (#strings > 0) then
		TIIP.URM.SendCommand("ulx setlimit",string.Implode(",",usergroups),string.Implode(",",strings),limit)
	end
end
...
urm.limits.deletebutton.DoClick = function()
	...
	if (#usergroups > 0) and (#strings > 0) then
		TIIP.URM.SendCommand("ulx removelimit",string.Implode(",",usergroups),string.Implode(",",strings))
	end
end
